        ...
        <div>
            {/* <div classNameName="modal">
                <div classNameName="modal-content">
                    ...
                    <p>Service Image: {service_img}</p>
                    <p>Service Provider Email: {provider_email}</p>
                    <p>User Email: {}</p>
                    <p>Price: {price}</p>
                    ...
                    <button onClick={handleBooking}>Purchase this Service</button>
            ...
            <form>
                ...
                <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Purchase Service</button>
            </form>
...
{/* <div>
    ...
    <button classNameName="btn" onClick={() => document.getElementById('my_modal_5').showModal()}>open modal</button>
